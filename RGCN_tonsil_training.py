...
for dist_threshold in dist_thresholds:
    ...
    test_loader = HGTLoader(train_hetero_data, num_samples=[1024] * 2, batch_size=128, input_nodes=('cell', None))
    # Get metadata
    ...
    torch.save(model.state_dict(),
               os.path.join(MODEL_PATH, f'{MODEL_NAME}_model_{dist_threshold}_{neighborhood_size_threshold}_weights.pth'))
